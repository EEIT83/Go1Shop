...
//		List<ProductProject1Bean> result = null;
		try (// Connection conn = DriverManager.getConnection(URL, USERNAME,PASSWORD);
			...
			StringBuilder SELECT = new StringBuilder("select * from product where prod_name like '%'+?+'%' ");
			
			SELECT.append(SQLgender);//and gender = 'M'
	...
	@Override
	public List<ProductProject1Bean> selectAll(String gender,String x) {
		//List<ProductProject1Bean> result = null;
