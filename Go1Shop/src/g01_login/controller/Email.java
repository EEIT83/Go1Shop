...
public class Email {
	private final String username = "eeit83eeit83@gmail.com";
	private final String password = "83eeit83eeit";
	...
	public boolean sendEmail(String toMailAdd,String mailTitle,String mailBody){
		...
		Properties props = new Properties();
		  ...
		  try {
		   ...
		   message.setSubject(mailTitle,"UTF-8");  //這是信件名稱
		   message.setText(mailBody,"UTF-8");  //這是內容
