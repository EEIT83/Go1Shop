...
<!-- 		<iframe src="<%=request.getContextPath()%>/g02_member/Modify.jsp" scrolling="no" frameborder="0" height="100%" id="modifyFrame" width="100%" onload='IFrameReSize("modifyFrame");IFrameReSizeWidth("modifyFrame");'></iframe> -->
