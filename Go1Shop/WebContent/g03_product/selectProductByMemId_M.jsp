...
<body>
			...
			<tbody>
				<c:forEach var="productVO" items="${productVOList}">
					<tr>
						...
						<td><a href="#" data-toggle="modal" data-target="#imgModal" id="img-${productVO.prodId}"
	...
	<form action="<c:url value='/ProductServlet.do'/>" method="get">
		memId:<input type="text" name="memId" /> <br /> <input type="hidden"
			name="action" value="getOneByMemId" /><br />
